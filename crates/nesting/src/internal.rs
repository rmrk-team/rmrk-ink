...
pub trait Internal {
    ...
    /// Adds a parent to a child nft.
    fn add_parent_to_child(&mut self, child_nft: &ChildNft, parent_token_id: &Id);

    /// Removes the parent of a child nft.
    fn remove_parent_from_child(&mut self, child_nft: &ChildNft);
}
