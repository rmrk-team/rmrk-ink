...
pub enum RmrkError {
    ...
    TooManyTokenPairsInBatch,
    TooManyTokensInBatch,
    TooManyTokensToTransfer,
...
impl ToString for RmrkError {
    fn to_string(&self) -> String {
        match self {
            ...
            RmrkError::TooManyTokenPairsInBatch => String::from("TooManyTokenPairsInBatch"),
            RmrkError::TooManyTokensInBatch => String::from("TooManyTokensInBatch"),
            RmrkError::TooManyTokensToTransfer => String::from("TooManyTokensToTransfer"),
