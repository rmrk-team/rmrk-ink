...
export default class Methods {
	...
	*/
	"getPart" (
		...
		return queryJSON( this.__nativeContract, this.__callerAddress, "base::getPart", [partId], __options , (result) => { return handleReturnType(result, getTypeDescription(57, 'rmrk_contract')); });
	}
